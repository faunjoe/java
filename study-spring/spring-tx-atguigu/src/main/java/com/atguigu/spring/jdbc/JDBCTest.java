...
public class JDBCTest {
    ...
    public void testDepartmentDao() {
        System.out.println(departmentDao.get(9));
    }

    @Test
    public void testEmployeeDao() {
        System.out.println(employeeDao.get(10));
    }
    ...
    public void testQueryForObject() {
        String sql = "SELECT id, last_name lastName, email FROM employees WHERE id = ?";
        RowMapper<Employee> rowMapper = new BeanPropertyRowMapper<Employee>(Employee.class);
        Employee employee = jdbcTemplate.queryForObject(sql, rowMapper, 10);
    ...
    public void testBatchUpdate() {
        ...
        batchArgs.add(new Object[]{"DD", "dd@atguigu.com"});
        batchArgs.add(new Object[]{"EE", "ee@atguigu.com"});
    ...
    public void testUpdate() {
        ...
        jdbcTemplate.update(sql, "Jack", 10);
    }
